...
\usepackage{times}
\usepackage{csquotes}
\usepackage[left=2cm,text={17cm, 24cm},top=25mm]{geometry}
...
Smíšená sazba má o~něco volnější pravidla než hladká sazba.  Nejčastěji se klasická sazba doplňuje o~další řezy písma pro zvýraznění důležitých pojmů. Existuje \uv{pravidlo}:
